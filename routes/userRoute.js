...
user_route.use('/img', express.static('img'));
...
user_route.post('/public-recipe',upload.single('image'),userController.addRecipe);

user_route.post('/upload-post-image',upload.single('image'),userController.uploadRecipeImage);
